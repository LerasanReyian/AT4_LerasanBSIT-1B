...
public class welcome extends javax.swing.JFrame {
    ...
    // this button is an event handler for add window (dungag)
    private void addUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addUserActionPerformed
        //initializing dungag with a new identifier 
        dungag dog = new dungag();
        dog.pack();// the use of this is to maintain and set the panel or window into its preffered sized
        dog.setLocationRelativeTo(null);//this method is use to maintain the window at the center of the screen while ruuning
        dog.setVisible(true);//window visibility is true
...
//this button used to go to delete window
    private void deleteuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteuActionPerformed
        //initializing delete with a new identifier
        delete dell = new delete();
        dell.setVisible(true);//window visibility is true 
        dell.pack();//the use of this is to maintain and set the panel or window into its preffered sized
        dell.setLocationRelativeTo(null);//this method is use to maintain the window at the center of the screen while ruuning
        this.dispose();//close the program after it go to another window

    }//GEN-LAST:event_deleteuActionPerformed
//fire to update window
    private void upuserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_upuserActionPerformed
        //initializing update with a new identifier
        update user = new update();
        user.pack();//the use of this is to maintain and set the panel or window into its preffered sized
        user.setLocationRelativeTo(null);//this method is use to maintain the window at the center of the screen while ruuning
        user.setVisible(true);//window visibility is true
        this.dispose();//close the program after it go to another window

    }//GEN-LAST:event_upuserActionPerformed
// this button will act as an logout but i will just fire back to login window
    private void logoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logoutActionPerformed
        // //initializing update with a new identifier
        login log = new login();
        log.pack();//the use of this is to maintain and set the panel or window into its preffered sized
        log.setLocationRelativeTo(log);//this method is use to maintain the window at the center of the screen while ruuning
        log.setVisible(true);//window visibility is true
        this.dispose();//close the program after it go to another window
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new welcome().setVisible(true);//displaying welcome window
            }
        });
    }
